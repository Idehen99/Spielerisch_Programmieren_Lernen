...
@onready var color = Settings.EyeColor
var anima = "idleDown"
...
func _on_eye_timer_timeout() -> void:
	set_eye_color("res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/1. Idle/Eyes/Female/" + color +".png")
	match color:
		"Black":
			color="Brown"
		"Blue":
...
func get_path_for_current_style(action:String , _anim: String):
	...
	match action:
		"idle":
			return [4, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/1. Idle/Eyes/Female/" + color +".png"]
		"walk":
			return [6, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/2. Walk/Eyes/Female/" + color +".png"]
		"run":
			return [8, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/3. Run/Eyes/Female/" + color +".png"]
		"axe":
			return [6, false,"res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/5. Axe and Sickle/Eyes/Female/" + color +".png"]
