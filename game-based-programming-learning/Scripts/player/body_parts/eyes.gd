...
func get_path_for_current_style(action:String , _anim: String):
	match action:
		"idle":
			return [6, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/1. Idle/Eyes/Female/" + color +".png"]
		"walk":
		...
		"run":
			return [6, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/3. Run/Eyes/Female/" + color +".png"]
		"axe":
