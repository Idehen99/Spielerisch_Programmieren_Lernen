...
func get_path_for_current_style(action:String , _anim: String):
	...
	match action:
		"idle": 
			return [4, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/1. Idle/Skins/" + skin +".png"]
		"walk":
			return [6, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/2. Walk/Skins/" + skin +".png"]
		"run":
			return [8, true, "res://Assets/Farm RPG - Tiny Asset Pack - (All in One)/Character and Portrait/Character/PNG/3. Run/Skins/" + skin +".png"]
		"axe":
